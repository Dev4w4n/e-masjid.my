...
export const EXAMPLE_LANDING_PAGE_DATA: LoadLandingPageResponse = {
  ...
  page_metadata: {
    ...
    title_en:
      "Sahaja TV Mosque - Display Official JAKIM Prayer Times on Your TV",
    description_ms:
      "Mudah, percuma, atau dengan ciri-ciri premium - cari kawasan anda dan mulai dalam 2 minit.",
    description_en:
      "Simple, free, or with premium features - find your zone and start in 2 minutes.",
...
export interface IDisplayRoutingService {
  ...
  initiateUpgrade(
    current_display_id: string,
    target_tier: string,
  ): Promise<InitiateTierUpgradeResponse>;
