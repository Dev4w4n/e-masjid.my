...
export const EXAMPLE_ASAS_TIER: TierPackageDTO = {
  ...
  name_en: "Asas (Free)",
  description_ms:
    "Sahaja TV Masjid mudah dan percuma – paparkan waktu solat JAKIM di TV anda dalam 2 minit tanpa pendaftaran. Pilih zon waktu, dan paparan rasmi akan mula berjalan dengan latar belakang standard. Tiada bayaran, tiada komitmen.",
  description_en:
    "Simple, free Sahaja TV – display official JAKIM prayer times on your TV in 2 minutes without registration. Select your time zone, and the official display starts with a standard background. No payment, no commitment.",
  price_ms: "Percuma",
  price_en: "Free",
  max_screens: 1,
...
export const EXAMPLE_MAJU_TIER: TierPackageDTO = {
  ...
  name_en: "Maju (Pro)",
  description_ms:
    "Paparkan gaya tersendiri dengan bantuan kami! Termasuk 3 gambar atau grafik tersuai setiap bulan — hantar apa yang anda mahu melalui WhatsApp, dan kami kemas kini paparan. Anda tidak perlu log masuk – fokus pada ibadah, biar kami urus paparan TV masjid anda.",
  description_en:
    "Show your own style with our help! Includes 3 custom images or graphics every month — send what you want via WhatsApp, and we update your display. You don't need to log in – focus on worship, let us manage your mosque TV display.",
  price_ms: "RM ~75",
  price_en: "RM ~75",
  max_screens: 1,
  requires_login: false,
...
export const EXAMPLE_GEMILANG_TIER: TierPackageDTO = {
  ...
  description_ms:
    "Kuasa penuh kawalan! Daftar masuk ke papan pemuka mesra pengguna untuk muat naik gambar, jadualkan pengumuman, dan kendalikan berbilang skrin sendiri. Termasuk support dan latihan ringkas. Selesaikan semuanya sendiri – fleksibiliti maksima bagi masjid sederhana hingga besar.",
  description_en:
    "Full control power! Log in to a user-friendly dashboard to upload images, schedule announcements, and manage multiple screens yourself. Includes support and brief training. Do it all yourself – maximum flexibility for medium to large mosques.",
  price_ms: "RM ~150",
  price_en: "RM ~150",
...
export const EXAMPLE_ISTIMEWA_TIER: TierPackageDTO = {
  ...
  description_ms:
    "Pakej tertinggi kami – bina paparan TV mengikut impian anda. Dari integrasi domain khusus hingga sokongan pembangunan API atau penggunaan multi-cawangan, kami akan rekaan khas yang memuatkan semua keperluan masjid besar anda. Hubungi untuk perbincangan dan sebut harga.",
  description_en:
    "Our highest tier – build your TV display according to your dreams. From custom domain integration to API development support or multi-branch usage, we create custom solutions that meet all your large mosque needs. Contact us for discussion and pricing.",
