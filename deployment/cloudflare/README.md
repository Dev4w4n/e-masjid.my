...
Build Settings:
  ...
  Build Command: pnpm install --frozen-lockfile && pnpm run build:packages && cd apps/public && pnpm build && cd ../.. && pnpm dlx @cloudflare/next-on-pages@1 --experimental-minify apps/public
...
Build Settings:
  Framework Preset: Next.js
  Build Command: pnpm install --frozen-lockfile && pnpm run build:packages && cd apps/tv-display && pnpm build && cd ../.. && pnpm dlx @cloudflare/next-on-pages@1 --experimental-minify apps/tv-display
