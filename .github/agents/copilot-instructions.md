...
- Supabase (PostgreSQL + Auth + Storage + Real-time) (007-tv-landing-tiers)
...
## Recent Changes
- 007-tv-landing-tiers: Added TypeScript 5.2+, React 18+, Node.js >=18.0.0 + Material-UI v6, React Router v6, Zustand, Vite
