# GitHub Copilot Instructions for Open E Masjid

## Project Overview

Open E Masjid is a comprehensive Islamic community management platform built as a monorepo with React 18+ frontend and Supabase backend. The system serves Malaysian mosques with multilingual support (Bahasa Malaysia/English) and follows strict constitutional principles for development.
