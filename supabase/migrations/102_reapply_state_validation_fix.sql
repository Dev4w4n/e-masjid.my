-- Re-apply state validation fix to ensure it's properly deployed
-- This is a duplicate of 101 to force redeployment if previous was cached
...
-- Update the zone suggestion function with inlined validation
