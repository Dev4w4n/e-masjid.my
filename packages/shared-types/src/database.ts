...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      masjids: {
        Row: {
          ...
          created_at: string
          created_by: string
          db_instance_url: string | null
          description: string | null
          email: string | null
          id: string
          jakim_zone_code: string | null
          local_admin_id: string | null
          location: Json | null
          name: string
        ...
        Relationships: [
          {
            foreignKeyName: "fk_masjids_local_admin_id"
            columns: ["local_admin_id"]
            isOneToOne: false
            referencedRelation: "local_admin_assignments"
            referencedColumns: ["local_admin_id"]
          },
          {
            foreignKeyName: "fk_masjids_local_admin_id"
            columns: ["local_admin_id"]
            isOneToOne: false
            referencedRelation: "local_admins"
            referencedColumns: ["id"]
          },
          {
      ...
      payment_transactions: {
        Row: {
          ...
          split_billing_details: Json | null
          status: string
          subscription_id: string
          toyyibpay_billcode: string | null
          toyyibpay_refno: string | null
          toyyibpay_transaction_time: string | null
          updated_at: string | null
        }
        Insert: {
          amount: number
        ...
        Relationships: [
          {
            foreignKeyName: "payment_transactions_masjid_id_fkey"
            columns: ["masjid_id"]
            isOneToOne: false
            referencedRelation: "masjids"
            referencedColumns: ["id"]
      ...
      schedule_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "schedule_rules_content_id_fkey"
            columns: ["content_id"]
            isOneToOne: false
            referencedRelation: "display_content"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "schedule_rules_masjid_id_fkey"
            columns: ["masjid_id"]
            isOneToOne: false
            referencedRelation: "masjids"
            referencedColumns: ["id"]
      ...
      subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "subscriptions_masjid_id_fkey"
            columns: ["masjid_id"]
            isOneToOne: true
            referencedRelation: "masjids"
            referencedColumns: ["id"]
    ...
    Functions: {
      check_grace_periods: { Args: never; Returns: undefined }
      check_local_admin_capacity: {
        Args: { p_local_admin_id: string }
        Returns: Json
      }
      check_tier_feature_access: {
        Args: { p_feature: string; p_masjid_id: string }
        Returns: boolean
      }
      cleanup_expired_content: { Args: never; Returns: undefined }
      cleanup_expired_preview_sessions: { Args: never; Returns: undefined }
      ...
      get_grace_period_notifications: {
        Args: never
        Returns: {
      ...
      get_masjid_subscription: { Args: { p_masjid_id: string }; Returns: Json }
      ...
      get_payment_history: {
        Args: { p_limit?: number; p_masjid_id: string }
        Returns: {
          amount: number
          paid_at: string
          split_billing: Json
          status: string
          toyyibpay_refno: string
      ...
      get_user_admin_masjids: { Args: never; Returns: string[] }
      get_user_masjids: {
      ...
      get_user_role:
        | { Args: { p_masjid_id: string; p_user_id: string }; Returns: string }
        | { Args: never; Returns: string }
      get_user_tier: { Args: never; Returns: string }
      is_admin: { Args: { p_user_id: string }; Returns: boolean }
      is_admin_of_masjid: { Args: { masjid_id: string }; Returns: boolean }
      is_in_grace_period: { Args: { p_masjid_id: string }; Returns: boolean }
      is_soft_locked: { Args: { p_masjid_id: string }; Returns: boolean }
      is_super_admin: { Args: never; Returns: boolean }
      is_user_masjid_admin: {
        Args: { target_masjid_id: string; target_user_id: string }
        Returns: boolean
      }
      restore_from_grace_period: {
        Args: { p_payment_transaction_id: string; p_subscription_id: string }
        Returns: Json
      }
      ...
      trigger_grace_period: {
        Args: { p_failure_reason?: string; p_subscription_id: string }
        Returns: Json
      }
    }
    Enums: {
      ...
      user_role: "super-admin" | "masjid-admin" | "local-admin" | "public-user"
    }
    CompositeTypes: {
      [_ in never]: never
    }
