...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      display_content: {
        Row: {
          ...
          sponsorship_tier:
            | Database["public"]["Enums"]["sponsorship_tier"]
            | null
          start_date: string
    ...
    Functions: {
      ...
      approve_content: {
        Args: { approver_id: string; content_id: string; notes?: string }
        Returns: {
          approval_notes: string | null
          approved_at: string | null
          approved_by: string | null
      ...
      withdraw_admin_application: {
        Args: { application_id: string; withdrawing_user_id: string }
        Returns: boolean
      }
    }
    Enums: {
