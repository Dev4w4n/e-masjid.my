...
export class TierService {
   ...
   * Task: T032
   */
  static getTierComparison(language: "en" | "bm" = "bm"): TierComparison[] {
    const rakyatDesc =
      language === "bm"
  ...
  static getFeatureDescriptions(
    ...
    const descriptions: FeatureDescription[] = [
      ...
      },
      {
        ...
        description_bm:
          "Kelulusan admin diperlukan sebelum kandungan disiarkan",
        category: "display",
      },
    ...
    descriptions.forEach((desc) => {
      result[desc.key] =
        language === "bm" ? desc.description_bm : desc.description_en;
    });
  ...
  static getRecommendedTier(usage: {
    ...
    if (
      usage.tv_displays > features.pro.max_tv_displays ||
    ...
    if (
      usage.tv_displays > features.rakyat.max_tv_displays ||
