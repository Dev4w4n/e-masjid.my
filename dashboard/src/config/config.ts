...
const prod = {
  ...
  url: {
    ...
    KHAIRAT_API_BASE_URL: `https://demoapi.e-masjid.my/api`,
    TABUNG_API_BASE_URL: `https://demoapi.e-masjid.my/api`,
    CADANGAN_API_BASE_URL: `https://demoapi.e-masjid.my/api`,
    TETAPAN_API_BASE_URL: `https://demoapi.e-masjid.my/api`,
