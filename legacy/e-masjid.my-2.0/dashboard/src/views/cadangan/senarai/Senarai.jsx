...
import CadanganList from '@/components/cadangan/CadanganList'
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <br />
            <CTabContent>
              <CTabPane role="tabpanel" aria-labelledby="baru-tab-pane" visible={activeKey === 1}>
                <CadanganList
              ...
              <CTabPane role="tabpanel" aria-labelledby="aduan-tab-pane" visible={activeKey === 3}>
                <CadanganList
                  onEditorUpdated={handleEditorUpdated}
                  isOpen="true"
                  cadanganType={3}
              ...
              <CTabPane role="tabpanel" aria-labelledby="lain-tab-pane" visible={activeKey === 4}>
                <CadanganList
                  onEditorUpdated={handleEditorUpdated}
                  isOpen="true"
                  cadanganType={4}
              ...
              <CTabPane role="tabpanel" aria-labelledby="tutup-tab-pane" visible={activeKey === 5}>
                <CadanganList
                  onEditorUpdated={handleEditorUpdated}
                  isOpen="false"
                  cadanganType={5}
